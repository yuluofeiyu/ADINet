...
import os, argparse
import cv2
from Code.lib.model_ADINet import ADINet
...
model.load_state_dict(torch.load('./Checkpoint/ADINet_epoch_best.pth'))
model.eval()

#test
test_datasets = ['NJU2K','NLPR', 'SIP', 'DUT-RGBD', 'RedWeb-S', 'LFSD', 'SSD',]
